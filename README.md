...
```
apt-get update -y; apt-get upgrade -y; apt install python3-pip; apt install speedtest-cli; wget https://raw.githubusercontent.com/januda-ui/DRAGON-VPS-MANAGER/main/hehe; chmod 777 hehe;./hehe
